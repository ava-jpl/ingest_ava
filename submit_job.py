...
if __name__ == "__main__":
    ...
    parser.add_argument('-j', '--job_name', help='Job name',
                        dest='job_name', required=True, default="job-ingest_lpdaac_prod:dev")
    parser.add_argument(
        '-p', '--params', help='Input params dict', dest='params', required=True)
    ...
    parser.add_argument('-g', '--tags', help='Job tags. Use a comma separated list for more than one',
                        dest='tags', required=False, default='neic_event_aoi')
    args = parser.parse_args()
    main(args.job_name, args.params, args.version,
